const e={userData:{username:"Guest",password:null,email:null,firstLogin:"2023-10-01,12:00",lastLogin:"2023-10-01,12:00",lastGame:null,lastGameData:null,totalTime:0,achievements:0,wins:0,losses:0,games:0},website:{name:"GameHUB",description:"A game hub for all your gaming needs.",version:"1.0.0"},me:{myName:"Shadow Shining",myEmail:"craftiaentity@gmail.com",myWebsite:"(maybe in the future)",myDescription:"A dude who doesn't know what to do in life.",myAvatarPath:"../Pictures/ShadowShining.png",myGitHub:"https://github.com/Shadow557"},settings:{theme:"light",titleColor:["#ff0000","#000000"],subtitleColor:["#000000","#ff0000"],backgroundColor:["#ffffff","#777777"]},games:[]};class t{_data;render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let a=this._generateMarkup();if(!t)return a;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",a),this._parentElement.classList.toggle("hidden")}renderFromMarkup(e,t=!0){if(!e||0===e.length)return this.renderError();this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",e),t&&this._parentElement.classList.toggle("hidden")}update(e){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let t=this._generateMarkup(),a=Array.from(document.createRange().createContextualFragment(t).querySelectorAll("*")),r=Array.from(this._parentElement.querySelectorAll("*"));a.forEach((e,t)=>{let a=r[t];e.isEqualNode(a)||e.firstChild?.nodeValue.trim()===""||(a.textContent=e.textContent),e.isEqualNode(a)||Array.from(e.attributes).forEach(e=>a.setAttribute(e.name,e.value))})}renderError(e=this._errorMessage){let t=`
      <div class="error">
        ...
        <p>${e}</p>
				...
				</div>`}addHandlerRender(e){this._targetElement.addEventListener("click",t=>{t.target.closest("#logo")&&(t.preventDefault(),e())})}}var l=new i;function s(){r._parentElement.classList.add("hidden")}r.addHandlerRender(function(){let t=e.userData;r.render(t,!0),document.querySelector("#accButtons").addEventListener("click",t=>{t.preventDefault(),"editAcc"===t.target.id?(r.renderFromMarkup(r._generateEditableMarkup(),!1),document.querySelector("#exitAcc").addEventListener("click",e=>{e.preventDefault(),s()}),document.querySelector("#editAccForm").addEventListener("submit",t=>{t.preventDefault();let a=new FormData(t.target),o={username:a.get("username"),password:a.get("password"),email:a.get("email")};e.userData={...e.userData,...o},r.update(e.userData),s()})):s()})}),n.addHandlerRender(function(){let t=e.settings;n.render(t,!0),document.querySelector("#editSettings").addEventListener("click",t=>{t.preventDefault(),n.renderFromMarkup(n._generateEditableMarkup(),!1),document.querySelector("#editSettingsForm").addEventListener("submit",t=>{t.preventDefault();let a=new FormData(t.target),r={titleColor:[a.get("titleColor1"),a.get("titleColor2")],subtitleColor:[a.get("subtitleColor1"),a.get("subtitleColor2")],backgroundColor:[a.get("backgroundColor1"),a.get("backgroundColor2")]};e.settings={...e.settings,...r},n.changeColors(r),n.update(e.settings),s()}),document.querySelector("#exitSettings").addEventListener("click",e=>{e.preventDefault(),s()})}),document.querySelector("#exitSettings").addEventListener("click",e=>{e.preventDefault(),s()})}),l.addHandlerRender(function(){l.render(e,!0),document.querySelector("#exit").addEventListener("click",e=>{e.preventDefault(),s()})});
//# sourceMappingURL=GameHUB.1150e530.js.map
