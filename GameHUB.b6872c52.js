function e(e,t,a,r){Object.defineProperty(e,t,{get:a,set:r,enumerable:!0,configurable:!0})}var t,a="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},i=a.parcelRequire658c;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var a={id:e,exports:{}};return r[e]=a,t.call(a.exports,a,a.exports),a.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){n[e]=t},a.parcelRequire658c=i);var o=i.register;o("3eicb",function(t,a){e(t.exports,"data",function(){return r}),e(t.exports,"setCurrentIndex",function(){return n}),e(t.exports,"getByCurrentIndex",function(){return i});let r={userData:{username:"Guest",password:null,email:null,firstLogin:"2023-10-01,12:00",lastLogin:"2023-10-01,12:00",lastGame:null,totalTime:0,achievements:0,wins:0,losses:0,currentPage:0},website:{name:"GameHUB",description:"A game hub for all your gaming needs.",version:"1.0.0"},me:{myName:"Shadow Shining",myEmail:"shadowshining432@gmail.com",myWebsite:"(maybe in the future)",myDescription:"A dude who knows what to do in life.",myAvatarPath:"../Pictures/ShadowShining.png",myGitHub:"https://github.com/Shadow557"},settings:{theme:"light",titleColor:["#ff0000","#000000"],subtitleColor:["#000000","#ff0000"],backgroundColor:["#ffffff","#777777"]},allGames:{id:{category:"minigames",game:0},minigames:[{name:"Tic Tac Toe",icon:"/Pictures/Guest.png",data:{id:"tic-tac-toe",description:"A classic game of Tic Tac Toe.",difficulty:"normal",spaces:[!1,!1,!1,!1,!1,!1,!1,!1,!1],round:0}},{name:"2048",icon:"Pictures/Guest.png",data:{id:"2048",description:"A sliding puzzle game where the goal is to combine tiles with the same number."}},{name:"Minesweeper",icon:"Pictures/Guest.png",data:{id:"minesweeper",description:"A classic puzzle game where the goal is to clear a minefield without detonating any mines."}},{name:"Snake",icon:"Pictures/Guest.png",data:{id:"snake",description:"A classic arcade game where the player controls a snake that grows in length."}},{name:"Sudoku",icon:"Pictures/Guest.png",data:{id:"sudoku",description:"A logic-based number placement puzzle where the goal is to fill a grid with numbers so that each column, row, and subgrid contains all the digits from 1 to 9."}},{name:"Solitaire",icon:"Pictures/Guest.png",data:{id:"solitaire",description:"A card game where the goal is to move all cards to foundation piles in a specific order."}}],games:[]}},n=e=>{if(e<0){r.allGames.id.game=r.allGames.minigames.length-1;return}if(e>=r.allGames.minigames.length){r.allGames.id.game=0;return}r.allGames.id.game=e},i=()=>{let e=r.allGames.id.category,t=r.allGames.id.game;return r.allGames[e][t]}}),o("eqyEW",function(t,a){e(t.exports,"default",function(){return r});class r{_data;render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let a=this._generateMarkup();if(!t)return a;this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",a),this._parentElement.classList.remove("hidden")}renderFromMarkup(e,t=!0){if(!e||0===e.length)return this.renderError();this._clear(),this._parentElement.insertAdjacentHTML("afterbegin",e),t&&this._parentElement.classList.remove("hidden")}update(e){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let t=this._generateMarkup(),a=Array.from(document.createRange().createContextualFragment(t).querySelectorAll("*")),r=Array.from(this._parentElement.querySelectorAll("*"));a.forEach((e,t)=>{let a=r[t];e.isEqualNode(a)||e.firstChild?.nodeValue.trim()===""||(a.textContent=e.textContent),e.isEqualNode(a)||Array.from(e.attributes).forEach(e=>a.setAttribute(e.name,e.value))})}renderError(e=this._errorMessage){let t=`
      <div class="error">
        <h2>Error</h2>
        <p>${e}</p>
      </div>`;this._parentElement.innerHTML="",this._parentElement.insertAdjacentHTML("afterbegin",t)}_clear(){this._parentElement.innerHTML=""}}}),Object.assign(i.i??={},{kISkd:"Guest.abd3a297.png"});var s=i("3eicb"),l=i("eqyEW");class d extends l.default{_parentElement=document.querySelector(".display");_targetElement=document.querySelector("#header");_errorMessage="No user data found. Please log in to view your account details.";_generateMarkup(){return`<div id="accDisplayContent">
					<h1>User window</h1>
				...
				</div>`}addHandlerRender(e){this._targetElement.addEventListener("click",t=>{t.target.closest("#logo")&&(t.preventDefault(),e())})}}var g=new h,l=i("eqyEW");class p extends l.default{_parentElement=document.querySelector("#gameZone");_errorMessage="My info are not available. Sorry.";_generateMarkup(){return`<div id="minigames" class="btn">Play Minigames</div>
                <div class="btn" id="games">Play Games</div>`}addHandlerRender(e){console.log(),this._parentElement.addEventListener("click",t=>{e(t.target)})}}var b=new p,l=i("eqyEW"),f={};t="kISkd",f=new URL("./"+(t=i.i?.[t]||t),import.meta.url).toString();class _ extends l.default{_parentElement=document.querySelector("#gameZone");_errorMessage="My info are not available. Sorry.";_generateMarkup(){var e;return`<div class="btn" id="back">\u{2190}</div>
			<div class="column">
            <a href="Pages/tic-tac-toe.html">
               <div class="game" id="${this._data.data.id}">
               <h2>${this._data.name}</h2>
                  <img src="${(e=f)&&e.__esModule?e.default:e}" alt="${this._data.name}" />
               </div>
            </a>
				<div class="btn" id="exit">Back</div>
			</div>
			<div class="btn" id="next">\u{2192}</div>
		</div>`}addHandlerRender(e){console.log(),this._parentElement.addEventListener("click",t=>{let a=t.target.closest(".game");a&&e(a)})}}var y=new _;function v(){u._parentElement.classList.add("hidden"),b._parentElement.classList.remove("hidden"),b._parentElement.innerHTML||C()}function C(e){let t=s.data;if(0===t.userData.currentPage){switch(t.userData.currentPage=1,e.id){case"minigames":s.setCurrentIndex(0);let a=s.getByCurrentIndex();y.render(a,!0);break;case"games":console.log("games");break;case"back":E(0);break;case"next":E(1);break;case"exit":E()}t.userData.currentPage=0}}function E(e){if(0===e)s.setCurrentIndex(s.data.allGames.id.game-1);else if(1===e)s.setCurrentIndex(s.data.allGames.id.game+1);else{s.setCurrentIndex(0),console.log("---minigames exit---"),b.render(1,!0);return}let t=s.getByCurrentIndex();y.update(t,!0)}u.addHandlerRender(function(){let e=s.data.userData;b._parentElement.classList.add("hidden"),u.render(e,!0),document.querySelector("#accButtons").addEventListener("click",e=>{e.preventDefault(),"editAcc"===e.target.id?(u.renderFromMarkup(u._generateEditableMarkup(),!1),document.querySelector("#exitAcc").addEventListener("click",e=>{e.preventDefault(),v()}),document.querySelector("#editAccForm").addEventListener("submit",e=>{e.preventDefault();let t=new FormData(e.target),a={username:t.get("username"),password:t.get("password"),email:t.get("email")};s.data.userData={...s.data.userData,...a},u.update(s.data.userData),v()})):v()})}),m.addHandlerRender(function(){let e=s.data.settings;b._parentElement.classList.add("hidden"),m.render(e,!0),document.querySelector("#editSettings").addEventListener("click",e=>{e.preventDefault(),m.renderFromMarkup(m._generateEditableMarkup(),!1),document.querySelector("#editSettingsForm").addEventListener("submit",e=>{e.preventDefault();let t=new FormData(e.target),a={titleColor:[t.get("titleColor1"),t.get("titleColor2")],subtitleColor:[t.get("subtitleColor1"),t.get("subtitleColor2")],backgroundColor:[t.get("backgroundColor1"),t.get("backgroundColor2")]};s.data.settings={...s.data.settings,...a},m.changeColors(a),m.update(s.data.settings),v()}),document.querySelector("#exitSettings").addEventListener("click",e=>{e.preventDefault(),v()})}),document.querySelector("#exitSettings").addEventListener("click",e=>{e.preventDefault(),v()})}),g.addHandlerRender(function(){let e=s.data;b._parentElement.classList.add("hidden"),b._parentElement.innerHTML="",g.render(e,!0),document.querySelector("#exit").addEventListener("click",e=>{e.preventDefault(),v()})}),b.addHandlerRender(C),y.addHandlerRender(function(){s.setCurrentIndex(2)});
//# sourceMappingURL=GameHUB.b6872c52.js.map
